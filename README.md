...
## Введение
Данная лабораторная работа направлена на решение определенной задачи тремя разными алгоритмами. При этом необходимо измерить время каждого алгоритма. Выяснить, какой алгоритм эффективнее на разных объемах входных данных.
> [!IMPORTANT]
